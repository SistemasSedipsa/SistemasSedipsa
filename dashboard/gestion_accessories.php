...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $consulta = "INSERT INTO accesorios_consumibles (consumible_id, nombre, modelo, ns, condicion) VALUES (?, ?, ?, ?, ?)";
    $resultado = $conexion->prepare($consulta);

    if ($resultado->execute([$consumible_id, $nombre, $modelo, $ns, $condicion])) {
